...
search_list = [
    ...
    "產業控股股份有限公司",
    "順天控股股份有限公司",
    "NAVIGATOR FINANCIAL LEASING CO LTD",
    "GOLDEN PRAISE INTERNATIONAL TRADE",
    "BRIGHT ARDOR CO., LTD.",
    "AUSGRID FINANCE PTY LTD.",
    "PQ DEVELOPMENT LIMITED",
    "GINKO INTERNATIONAL CO., LTD.",
    "富華實業有限公司",
    "GOME HOLDINGS GROUP CO., LTD.",
    "CHARIOT POWER INVESTMENTS LIMITED",
    "NETWORK FINANCE COMPANY PTY LTD",
    "愛智輝實業股份有限公司",
    "恒旭金融股份有限公司",
    "CIENEGA HOLDINGS LIMITED",
    "中合投資集團有限公司",
    "MAXXS RUBBER INDIA PRIVATE LTD.",
    "INDOL MONTNEY LTD.",
    "NAVIGATOR EMERGING MARKET",
    "達誠股份有限公司",
    "CHI FU INVESTMENT (CHINA) INC., LTD.",
    "WELLMART TECHNOLOGY LLC.",
    "VINGROUP JOINT STOCK COMPANY",
    "亞洲投資有限公司",
    "PIOTEK COMPUTER (SUZHOU) CO., LTD.",
    "吉富股份有限公司",
    "EVERFULL GROUP LIMITED"
]
# User-Agent list
USER_AGENTS = [
...
def scrape_func(update=False, target='上海商銀'):
    ...
    # Load existing data
    final_csv_file_path = current_target+'_news_data_cleaned.csv'
    ...
    if update:
        ...
        num_search=9999
    print(f"proceeding searching for {search_target} for {num_search} articles")
    ...
    new_csv_file_path = current_target+'_news_data_cleaned.csv'
...
if __name__ == '__main__':
    ...
    for current_target in search_list:          
